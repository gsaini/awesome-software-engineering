...
- **AI & Agentic Engineering** → [whitepapers/ai-agentic-engineering/](whitepapers/ai-agentic-engineering/) · [notes/loop-engineering.md](notes/loop-engineering.md) · [notes/building-agent-evaluators.md](notes/building-agent-evaluators.md) · [notes/model-context-protocol.md](notes/model-context-protocol.md)
